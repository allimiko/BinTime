...
public class Task2 extends TestBase {
    private String monitoren = "/monitoren/";
    private String priceRangeUrl = "?priceRange=";
    private String priceRangeLow = "#priceRangeLow";
    private String priceRangehigh = "#priceRangehigh";
